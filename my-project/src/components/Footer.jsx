      ...
      <section className="  pb-20">
        <div className="mx-24 text-[#374772]  justify-between flex  ">
          <div className="pr-9 w-80 border-r">
            <Link to="/">
              <img src={logo} alt="logo" className={`w-36 ${FooterColour}`} />
            </Link>
          ...
          <div className="text-justify w-80 pl-5 border-r ">
            ...
            <div className="gap-3 flex flex-col">
              <div className="hover:translate-x-4 duration-700">
          ...
          <div className="text-justify w-80 pl-5 border-r ">
            ...
            <div className="gap-3 flex flex-col">
              <Link to="/see-do" className="hover:translate-x-4 duration-700">
                See & Do{" "}
              </Link>
              <div className="hover:translate-x-4 duration-700">
                Plan sYour Trip
      ...
      <footer className={`${FooterColour}`}>
        <div className="mx-24 text-[#fffff3] pt-12 pb-10 text-justify justify-between flex  ">
          ...
          <div className="text-justify w-80 pl-5 border-r ">
            ...
            <button
              ...
              className={`inline-flex  mr-10 w-24 justify-center gap-x-1.5 rounded-md  ${FooterColour} px-3 py-1 text-sm  text-gray-900 `}
              id="menu-button"
              aria-expanded="true"
              aria-haspopup="true"
            >
              ...
              {dropdownShow && (
                <div
                  className={`absolute right-18 z-10 border-[#374772] mt-2 w-24 origin-top-right rounded-md  ${FooterColour} shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none`}
                  role="menu"
          ...
          <div className="text-justify w-80 pl-5 border-r ">
            <header className=" text-lg font-semibold pb-6">Call center</header>
        ...
        <div className="mx-24 border-t  text-sm text-[#fffff3] py-8  text-justify justify-between flex">
          ...
          <div className="flex gap-5 items-center ">
            ...
            <button className="flex items-center gap-2 border-l p-2">
              Back to top
              <IoIosArrowDropupCircle />
            </button>
          </div>
